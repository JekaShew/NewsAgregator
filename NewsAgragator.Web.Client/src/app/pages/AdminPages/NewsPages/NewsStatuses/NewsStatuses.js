...
const NewsStatuses = (props) => {
        ...
        if (loading == false) {
            return (
                <table className="table table-bordered table-hover">
                    ...
                    <tbody>
                        {props.value.newsStatuses.value.map(x => (
    ...
    useEffect(() => {
        setLoading(props.value.newsStatuses.loading);
    }, [props.value.newsStatuses.loading]);
    ...
    return (
        <Wrapper>
            <div className="editPage">
                <div className="pageTitle"> News Statuses </div>
...
const mapStateToProps = (state) => (console.log("mapStateToProps"), {
    ...
    value: state.newsStatuses,
});

export default connect(mapStateToProps, mapDispatchToProps)(NewsStatuses);