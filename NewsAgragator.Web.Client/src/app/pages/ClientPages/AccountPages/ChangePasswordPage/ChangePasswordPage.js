...
import { changePassword, select, clearState } from './actions';
        ...
        for (const validation in validations) {
            switch (validation) {
                ...
                case 'confirmationPassword':
                    const pass = props.value.newPassword.value;
                    value != pass ? 
...
const ChangePasswordPage = (props) => {    
    ...
    const renderForgotBtn = () => {     
        ...
        return (<button disabled={disabled} className="btnSign" onClick={() => changePassword()}>Change Password</button>);
    }
        ...
        if (managingState.Loading == false) {
            return (
                <div className="editPageInputs">
                    ...
                    <div className="divInput">
                        <div className="inputTitle"> Old Password</div>
                        <input
                            className="input"
                            type="text"
                            placeholder=" Old Password"
                            value={oldPassword.value}
                            onChange={(e) => oldPassword.onChange(e,props.select,"oldPassword")}
                            onBlur={(e) => oldPassword.onBlur(e)}
                        />
                    </div>
                    {
                        renderValidationMessages(oldPassword)
                    }
                    <div className="divInput">
